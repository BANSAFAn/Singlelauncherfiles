...
/* 225 */       if (i != 0) {
/* 226 */         out.beginArray();
/* 227 */         for (int j = 0, size = keys.size(); j < size; j++) {
/* 228 */           out.beginArray();
...
/*     */       } else {
/* 235 */         out.beginObject();
/* 236 */         for (int j = 0, size = keys.size(); j < size; j++) {
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\com\google\gson\internal\bind\MapTypeAdapterFactory.class
