...
/*  72 */     this
/*     */       
/*  74 */       .comparator = (comparator != null) ? comparator : (Comparator)NATURAL_ORDER;
/*     */   }
/*     */   
/*     */   public int size() {
/*  78 */     return this.size;
...
/*     */ 
/*     */       
/* 131 */       Comparable<Object> comparableKey = (comparator == NATURAL_ORDER) ? (Comparable<Object>)key : null;
/*     */ 
/*     */ 
/*     */       
/*     */       while (true) {
...
/*     */     
/*     */     public int hashCode() {
/* 491 */       return ((this.key == null) ? 0 : this.key.hashCode()) ^ (
/* 492 */         (this.value == null) ? 0 : this.value.hashCode());
/*     */     }
/*     */     
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\com\google\gson\internal\LinkedTreeMap.class
