...
/*  73 */     this
/*     */       
/*  75 */       .comparator = (comparator != null) ? comparator : (Comparator)NATURAL_ORDER;
...
/*     */ 
/*     */       
/* 144 */       Comparable<Object> comparableKey = (comparator == NATURAL_ORDER) ? (Comparable<Object>)key : null;
/*     */ 
/*     */ 
/*     */       
/*     */       while (true) {
...
/*     */ 
/*     */     
/* 420 */     root.height = Math.max((left != null) ? left.height : 0, 
/* 421 */         (pivotLeft != null) ? pivotLeft.height : 0) + 1;
/* 422 */     pivot.height = Math.max(root.height, 
/* 423 */         (pivotRight != null) ? pivotRight.height : 0) + 1;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 448 */     root.height = Math.max((right != null) ? right.height : 0, 
/* 449 */         (pivotRight != null) ? pivotRight.height : 0) + 1;
/* 450 */     pivot.height = Math.max(root.height, 
/* 451 */         (pivotLeft != null) ? pivotLeft.height : 0) + 1;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public int hashCode() {
/* 522 */       return ((this.key == null) ? 0 : this.key.hashCode()) ^ (
/* 523 */         (this.value == null) ? 0 : this.value.hashCode());
/*     */     }
/*     */     
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\com\google\gson\internal\LinkedHashTreeMap.class
