...
/* 300 */           return ConnPoolByRoute.this.getEntryBlocking(route, state, timeout, tunit, aborter);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 331 */     if (timeout > 0L) {
/* 332 */       deadline = new Date(System.currentTimeMillis() + tunit.toMillis(timeout));
/*     */     }
/*     */ 
/*     */     
...
/* 720 */       this.log.debug("Closing connections idle longer than " + t + " " + tunit);
/*     */     }
/*     */     
/* 723 */     long deadline = System.currentTimeMillis() - tunit.toMillis(t);
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\http\impl\conn\tsccm\ConnPoolByRoute.class
