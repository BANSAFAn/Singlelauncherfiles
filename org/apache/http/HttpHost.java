...
/* 308 */       HttpHost that = (HttpHost)obj;
/* 309 */       return (this.lcHostname.equals(that.lcHostname) && this.port == that.port && this.schemeName.equals(that.schemeName) && ((this.address == null) ? (that.address == null) : this.address.equals(that.address)));
/*     */     } 
/*     */ 
/*     */ 
/*     */     
...
/* 327 */     if (this.address != null) {
/* 328 */       hash = LangUtils.hashCode(hash, this.address);
/*     */     }
/* 330 */     return hash;
/*     */   }
/*     */ 
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\http\HttpHost.class
