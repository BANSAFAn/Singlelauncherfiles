...
/*  294 */     { result.append('X');
/*  295 */       index += 3; }
/*  296 */     else { if (contains(value, index, 2, new String[] { "CC" }) && (index != 1 || charAt(value, 0) != 'M'))
/*      */       {
/*      */         
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\codec\language\DoubleMetaphone.class
