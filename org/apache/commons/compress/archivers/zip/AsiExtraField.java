...
/*     */ {
/*  58 */   private static final ZipShort HEADER_ID = new ZipShort(30062);
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  86 */   private CRC32 crc = new CRC32();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 109 */     return new ZipShort(14 + (
/*     */ 
/*     */ 
/*     */ 
/*     */         
/* 114 */         getLinkedFile().getBytes(Charset.defaultCharset())).length);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */     System.arraycopy(ZipShort.getBytes(getMode()), 0, data, 0, 2);
/*     */     
/* 139 */     byte[] linkArray = getLinkedFile().getBytes(Charset.defaultCharset());
/*     */     
/* 141 */     System.arraycopy(ZipLong.getBytes(linkArray.length), 0, data, 2, 4);
/*     */     
/* 143 */     System.arraycopy(ZipShort.getBytes(getUserId()), 0, data, 6, 2);
/* 144 */     System.arraycopy(ZipShort.getBytes(getGroupId()), 0, data, 8, 2);
/*     */     
...
/* 304 */       this.link = new String(linkArray, Charset.defaultCharset());
/*     */     } 
/*     */     
...
/*     */       
/* 345 */       throw new IllegalStateException(cnfe);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\archivers\zip\AsiExtraField.class
