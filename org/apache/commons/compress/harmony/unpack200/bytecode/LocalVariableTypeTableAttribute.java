...
/*  93 */     List<CPUTF8> nestedEntries = new ArrayList<>();
...
/*     */     } 
/*  99 */     return nestedEntries.<ClassFileEntry>toArray(ClassFileEntry.NONE);
/*     */   }
/*     */ 
/*     */   
/*     */   protected int[] getStartPCs() {
/* 104 */     return this.start_pcs;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 116 */     int[] unrenumbered_start_pcs = new int[this.start_pcs.length];
/* 117 */     System.arraycopy(this.start_pcs, 0, unrenumbered_start_pcs, 0, this.start_pcs.length);
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 130 */     int maxSize = this.codeLength;
/*     */ 
/*     */ 
/*     */     
/* 134 */     for (int index = 0; index < this.lengths.length; index++) {
/* 135 */       int start_pc = this.start_pcs[index];
/* 136 */       int revisedLength = -1;
/* 137 */       int encodedLength = this.lengths[index];
/*     */ 
/*     */       
/* 140 */       int indexOfStartPC = unrenumbered_start_pcs[index];
/*     */ 
/*     */       
/* 143 */       int stopIndex = indexOfStartPC + encodedLength;
/* 144 */       if (stopIndex < 0) {
...
/*     */       } else {
/*     */         
/* 155 */         int stopValue = ((Integer)byteCodeOffsets.get(stopIndex)).intValue();
/* 156 */         revisedLength = stopValue - start_pc;
/*     */       } 
/* 158 */       this.lengths[index] = revisedLength;
/*     */     } 
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 164 */     return "LocalVariableTypeTable: " + this.local_variable_type_table_length + " varaibles";
/*     */   }
/*     */ }


/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\bytecode\LocalVariableTypeTableAttribute.class
