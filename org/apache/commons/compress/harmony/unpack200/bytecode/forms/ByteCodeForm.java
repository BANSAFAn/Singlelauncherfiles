...
/*  31 */   protected static final Map<String, ByteCodeForm> byteCodesByName = new HashMap<>(256);
/*     */   static {
...
/*     */ 
/*     */     
/* 286 */     for (ByteCodeForm byteCode : byteCodeArray) {
/* 287 */       if (byteCode != null) {
/* 288 */         byteCodesByName.put(byteCode.getName(), byteCode);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 306 */     this(opcode, name, new int[] { opcode });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 321 */     calculateOperandPosition();
/*     */   }
/*     */   
/*     */   protected void calculateOperandPosition() {
/* 325 */     this.firstOperandIndex = -1;
/* 326 */     this.operandLength = -1;
/*     */ 
/*     */     
/* 329 */     int iterationIndex = 0;
/* 330 */     while (iterationIndex < this.rewrite.length) {
/* 331 */       if (this.rewrite[iterationIndex] < 0) {
/*     */         
/* 333 */         this.firstOperandIndex = iterationIndex;
/* 334 */         iterationIndex = this.rewrite.length; continue;
/*     */       } 
/* 336 */       iterationIndex++;
/*     */     } 
/*     */ 
/*     */     
/* 340 */     if (this.firstOperandIndex == -1) {
/*     */       return;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/* 346 */     int lastOperandIndex = -1;
/* 347 */     iterationIndex = this.firstOperandIndex;
/* 348 */     while (iterationIndex < this.rewrite.length) {
/* 349 */       if (this.rewrite[iterationIndex] < 0) {
/* 350 */         lastOperandIndex = iterationIndex;
/*     */       }
/* 352 */       iterationIndex++;
/*     */     } 
/*     */ 
/*     */     
/* 356 */     int difference = lastOperandIndex - this.firstOperandIndex;
/*     */ 
/*     */     
/* 359 */     if (difference < 0) {
/* 360 */       throw new Error("Logic error: not finding rewrite operands correctly");
/*     */     }
/* 362 */     this.operandLength = difference + 1;
/*     */   }
/*     */   
/*     */   public static ByteCodeForm get(int opcode) {
/* 366 */     return byteCodeArray[opcode];
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 371 */     return getClass().getName() + "(" + getName() + ")";
/*     */   }
/*     */   
/*     */   public int getOpcode() {
/* 375 */     return this.opcode;
/*     */   }
/*     */   
...
/* 383 */     return this.rewrite;
/*     */   }
/*     */   
/*     */   public int[] getRewriteCopy() {
/* 387 */     int[] result = new int[this.rewrite.length];
/* 388 */     System.arraycopy(this.rewrite, 0, result, 0, this.rewrite.length);
/* 389 */     return result;
/*     */   }
/*     */   
/*     */   public int firstOperandIndex() {
/* 393 */     return this.firstOperandIndex;
/*     */   }
/*     */   
/*     */   public int operandLength() {
/* 397 */     return this.operandLength;
/*     */   }
/*     */   
...
/* 413 */     if (this.rewrite.length > 1 && this.rewrite[0] == 42)
/*     */     {
/*     */ 
/*     */       
/* 417 */       return (this.rewrite[1] > 0);
/*     */     }
/* 419 */     return false;
/*     */   }
/*     */ 
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\bytecode\forms\ByteCodeForm.class
