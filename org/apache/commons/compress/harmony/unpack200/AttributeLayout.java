...
/*     */     }
/* 189 */     return getValue("K" + type + this.layout.substring(2), value, pool);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 198 */       r = r * 31 + this.name.hashCode();
/*     */     }
/* 200 */     if (this.layout != null) {
/* 201 */       r = r * 31 + this.layout.hashCode();
/*     */     }
/* 203 */     r = r * 31 + this.index;
/* 204 */     r = r * 31 + this.context;
/* 205 */     return r;
/*     */   }
/*     */ 
/*     */ 
...
/* 215 */     return ((value & this.mask) != 0L);
/*     */   }
/*     */ 
/*     */   
/*     */   public String toString() {
/* 220 */     return contextNames[this.context] + ": " + this.name;
/*     */   }
/*     */   
...
/* 237 */       return 1;
/*     */     }
/* 239 */     return this.backwardsCallCount;
/*     */   }
/*     */   
/*     */   public boolean isDefaultLayout() {
/* 243 */     return this.isDefault;
/*     */   }
/*     */   
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\AttributeLayout.class
