...
/*     */                 break;
/*     */               case 170:
/* 192 */                 switchIsTableSwitch.add(Boolean.TRUE);
/* 193 */                 bcCaseCountCount++;
/* 194 */                 bcLabelCount++;
/*     */                 break;
/*     */               case 171:
/* 197 */                 switchIsTableSwitch.add(Boolean.FALSE);
...
/* 340 */     ArrayList[][] arrayOfArrayList = (ArrayList[][])this.segment.getClassBands().getMethodAttributes();
...
/*     */     
/* 361 */     int i = 0;
/* 362 */     ArrayList<List<Attribute>> orderedCodeAttributes = this.segment.getClassBands().getOrderedCodeAttributes();
...
/* 393 */               int handlerClass = handlerClassTypes[i][j] - 1;
...
/*     */               }
/* 401 */               ExceptionTableEntry entry = new ExceptionTableEntry(handlerStartPCs[i][j], handlerEndPCs[i][j], handlerCatchPCs[i][j], cpHandlerClass);
/*     */               
...
/*     */           
/* 408 */           List<Attribute> methodAttributesList = arrayOfArrayList[c][m];
/*     */           
/* 410 */           int indexForCodeAttr = 0;
/* 411 */           for (Attribute attribute : methodAttributesList) {
/* 412 */             if (!(attribute instanceof NewAttribute) || ((NewAttribute)attribute)
/* 413 */               .getLayoutIndex() >= 15) {
/*     */               break;
/*     */             }
/* 416 */             indexForCodeAttr++;
/*     */           } 
/* 418 */           methodAttributesList.add(indexForCodeAttr, codeAttr);
/* 419 */           codeAttr.renumber(codeAttr.byteCodeOffsets);
/*     */           
/* 421 */           if (allCodeHasFlags) {
/* 422 */             currentAttributes = orderedCodeAttributes.get(i);
/* 423 */           } else if (codeHasFlags[i]) {
/* 424 */             currentAttributes = orderedCodeAttributes.get(codeAttributeIndex);
/* 425 */             codeAttributeIndex++;
/*     */           } else {
/* 427 */             currentAttributes = Collections.EMPTY_LIST;
/*     */           } 
/* 429 */           for (Attribute currentAttribute : currentAttributes) {
/* 430 */             codeAttr.addAttribute(currentAttribute);
/*     */             
/* 432 */             if (currentAttribute.hasBCIRenumbering()) {
/* 433 */               ((BCIRenumberedAttribute)currentAttribute).renumber(codeAttr.byteCodeOffsets);
/*     */             }
/*     */           } 
/* 436 */           i++;
/*     */         } 
...
/* 443 */     return ((codePacked >= 153 && codePacked <= 166) || codePacked == 198 || codePacked == 199);
/*     */   }
/*     */   
/*     */   private boolean endsWithLoad(int codePacked) {
/* 447 */     return (codePacked >= 21 && codePacked <= 25);
/*     */   }
/*     */   
/*     */   private boolean endsWithStore(int codePacked) {
/* 451 */     return (codePacked >= 54 && codePacked <= 58);
/*     */   }
/*     */   
/*     */   public byte[][][] getMethodByteCodePacked() {
/* 455 */     return this.methodByteCodePacked;
/*     */   }
/*     */   
/*     */   public int[] getBcCaseCount() {
/* 459 */     return this.bcCaseCount;
/*     */   }
/*     */   
/*     */   public int[] getBcCaseValue() {
/* 463 */     return this.bcCaseValue;
/*     */   }
/*     */   
/*     */   public int[] getBcByte() {
/* 467 */     return this.bcByte;
/*     */   }
/*     */   
/*     */   public int[] getBcClassRef() {
/* 471 */     return this.bcClassRef;
/*     */   }
/*     */   
/*     */   public int[] getBcDoubleRef() {
/* 475 */     return this.bcDoubleRef;
/*     */   }
/*     */   
/*     */   public int[] getBcFieldRef() {
/* 479 */     return this.bcFieldRef;
/*     */   }
/*     */   
/*     */   public int[] getBcFloatRef() {
/* 483 */     return this.bcFloatRef;
/*     */   }
/*     */   
/*     */   public int[] getBcIMethodRef() {
/* 487 */     return this.bcIMethodRef;
/*     */   }
/*     */   
/*     */   public int[] getBcInitRef() {
/* 491 */     return this.bcInitRef;
/*     */   }
/*     */   
/*     */   public int[] getBcIntRef() {
/* 495 */     return this.bcIntRef;
/*     */   }
/*     */   
/*     */   public int[] getBcLabel() {
/* 499 */     return this.bcLabel;
/*     */   }
/*     */   
/*     */   public int[] getBcLocal() {
/* 503 */     return this.bcLocal;
/*     */   }
/*     */   
/*     */   public int[] getBcLongRef() {
/* 507 */     return this.bcLongRef;
/*     */   }
/*     */   
/*     */   public int[] getBcMethodRef() {
/* 511 */     return this.bcMethodRef;
/*     */   }
/*     */   
/*     */   public int[] getBcShort() {
/* 515 */     return this.bcShort;
/*     */   }
/*     */   
/*     */   public int[] getBcStringRef() {
/* 519 */     return this.bcStringRef;
/*     */   }
/*     */   
/*     */   public int[] getBcSuperField() {
/* 523 */     return this.bcSuperField;
/*     */   }
/*     */   
/*     */   public int[] getBcSuperMethod() {
/* 527 */     return this.bcSuperMethod;
/*     */   }
/*     */   
/*     */   public int[] getBcThisField() {
/* 531 */     return this.bcThisField;
/*     */   }
/*     */   
/*     */   public int[] getBcThisMethod() {
/* 535 */     return this.bcThisMethod;
/*     */   }
/*     */ }


/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\BcBands.class
