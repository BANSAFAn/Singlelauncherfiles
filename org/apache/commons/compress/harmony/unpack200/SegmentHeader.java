...
/* 367 */     int total = in.read(data);
/* 368 */     if (total == -1) {
/* 369 */       throw new EOFException("Failed to read any data from input stream");
/*     */     }
/* 371 */     while (total < data.length) {
/* 372 */       int delta = in.read(data, total, data.length - total);
/* 373 */       if (delta == -1) {
/* 374 */         throw new EOFException("Failed to read some data from input stream");
/*     */       }
/* 376 */       total += delta;
/*     */     } 
/*     */   }
...
/* 381 */     return this.bandHeadersSize;
/*     */   }
/*     */ }


/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\SegmentHeader.class
