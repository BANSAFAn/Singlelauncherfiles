...
/*  83 */     this.member = true;
/*  84 */     this.cachedOuterClassIndex = -1;
/*  85 */     this.cachedSimpleClassNameIndex = -1; this.C = C; this.F = F; this.C2 = C2;
/*     */     this.N = N;
/*     */     this.cIndex = cIndex;
...
/*  95 */     initializeClassStrings(); } public boolean predicted() { return (this.predictOuter || this.predictSimple); }
/*     */   
/*     */   private String cachedSimpleClassName; private boolean initialized; private boolean anonymous; private boolean outerIsAnonymous; private boolean member;
...
/* 104 */     return ((this.F & 0x10000) == 65536);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 114 */     List<String> resultList = new ArrayList<>();
/* 115 */     int start = 0;
/* 116 */     int index = 0;
...
/*     */       }
/*     */     } 
/* 128 */     return resultList.<String>toArray(EMPTY_STRING_ARRAY);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmon\\unpack200\IcTuple.class
