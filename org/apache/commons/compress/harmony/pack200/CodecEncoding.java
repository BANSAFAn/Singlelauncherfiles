...
/* 183 */       HashMap<BHSDCodec, Integer> reverseMap = new HashMap<>(canonicalCodec.length);
...
/* 236 */         index++;
/*     */       } 
/* 238 */       for (int element : aSpecifier) {
/* 239 */         specifier[index] = element;
/* 240 */         index++;
/*     */       } 
/* 242 */       for (int element : bSpecifier) {
/* 243 */         specifier[index] = element;
/* 244 */         index++;
/*     */       } 
...
/* 258 */         if (tokenCodec == Codec.BYTE1) {
/* 259 */           tDefL = 1;
/* 260 */         } else if (tokenCodec instanceof BHSDCodec) {
/* 261 */           BHSDCodec tokenBHSD = (BHSDCodec)tokenCodec;
/* 262 */           if (tokenBHSD.getS() == 0) {
/* 263 */             int[] possibleLValues = { 4, 8, 16, 32, 64, 128, 192, 224, 240, 248, 252 };
/* 264 */             int l = 256 - tokenBHSD.getH();
/* 265 */             int i = Arrays.binarySearch(possibleLValues, l);
/* 266 */             if (i != -1)
/*     */             {
/* 268 */               tDefL = i++;
/*     */             }
...
/*     */         } 
/*     */       }
/* 273 */       int first = 141 + fDef + 2 * uDef + 4 * tDefL;
/* 274 */       int[] favouredSpecifier = (fDef == 1) ? new int[0] : getSpecifier(favouredCodec, defaultForBand);
/* 275 */       int[] tokenSpecifier = (tDefL != 0) ? new int[0] : getSpecifier(tokenCodec, defaultForBand);
/* 276 */       int[] unfavouredSpecifier = (uDef == 1) ? new int[0] : getSpecifier(unfavouredCodec, defaultForBand);
/* 277 */       int[] specifier = new int[1 + favouredSpecifier.length + unfavouredSpecifier.length + tokenSpecifier.length];
/*     */       
/* 279 */       specifier[0] = first;
/* 280 */       int index = 1;
/* 281 */       for (int element : favouredSpecifier) {
/* 282 */         specifier[index] = element;
/* 283 */         index++;
/*     */       } 
/* 285 */       for (int element : tokenSpecifier) {
/* 286 */         specifier[index] = element;
/* 287 */         index++;
/*     */       } 
/* 289 */       for (int element : unfavouredSpecifier) {
/* 290 */         specifier[index] = element;
/* 291 */         index++;
/*     */       } 
/* 293 */       return specifier;
/*     */     } 
/*     */     
/* 296 */     return null;
/*     */   }
...
/* 300 */     return canonicalCodec[i];
/*     */   }
/*     */ }


/* Location:              C:\Users\vovas\Downloads\TLauncher-2.885.jar!\org\apache\commons\compress\harmony\pack200\CodecEncoding.class
